...
cc -Wall -Wextra -Werror -I../includes test_process_color.c ../process_texture_color.c ../map_info_fn.c ../ft_putstr_fd.c -o TEST3
cc -Wall -Wextra -Werror -I../includes test_process_texture.c ../process_texture_color.c ../map_info_fn.c ../ft_putstr_fd.c -o TEST4
...
cc -Wall -Wextra -Werror -I../includes test_scan_set_start.c ../map_scan_set_start.c ../ft_putstr_fd.c -o TEST7
